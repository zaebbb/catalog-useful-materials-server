import { type CodeTypePattern } from '@model/NotesModel/lib/types/patterns/CodeTypePattern'
...
export const createNotePatternCode = async (noteData: CodeTypePattern): Promise<string> => {
  const code = v4()
